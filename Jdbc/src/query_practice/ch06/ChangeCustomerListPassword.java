...
public class ChangeCustomerListPassword {
	...
	public static void main(String[] args) {
		...
		query.append("{call change_customer_password(?,?) }");

		List<Customer> customerList = new ArrayList<Customer>();
		customerList.add(new Customer("kimsw","kimsw1234"));
		customerList.add(new Customer("yoonjh","yoonjh1234"));
